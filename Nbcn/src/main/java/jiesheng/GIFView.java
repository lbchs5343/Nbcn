...
public class GIFView
    ...
    protected void onMeasure(int n, int n2) {
        if (this.mMovie != null) {
            ...
            if (0x40000000 == View.MeasureSpec.getMode((int) n) || 0x40000000 == View.MeasureSpec.getMode((int) n2)) {
                this.moviemode = 1;
    ...
    public void setMovieResource(String string) {
        this.mMovie = Movie.decodeFile((String) string);
        this.requestLayout();
    }

    public void setMovieResource(byte[] byArray) {
        this.mMovie = Movie.decodeByteArray((byte[]) byArray, (int) 0, (int) byArray.length);
        this.requestLayout();
    }
}
