...
public class 数据报
    ...
    public static interface 接收到数据 {
        public void 接收到数据(byte[] var1);
    }
    ...
    static class UDPBuild {
        ...
        private UDPBuild() {
            ...
            this.mThreadPool = Executors.newFixedThreadPool((int) (n * 5));
        }
        ...
        public static interface OnUDPReceiveCallbackBlock {
            public void OnParserComplete(DatagramPacket var1);
        }
    }
}
