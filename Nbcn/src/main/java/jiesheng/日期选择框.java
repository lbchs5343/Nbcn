...
public class 日期选择框
    ...
    public static String datePickerBox(Context context, int n, int n2, int n3) {
        ...
        datePickerDialog.setButton((CharSequence) "确定", new DialogInterface.OnClickListener() {

            public void onClick(DialogInterface dialogInterface, int n) {
                handler.sendMessage(handler.obtainMessage());
            }
        });
        datePickerDialog.setButton2((CharSequence) "取消", new DialogInterface.OnClickListener() {
    ...
    public static interface 日期被确定 {
        public void 日期被确定(int var1, int var2, int var3);
    }

    public static interface 日期被改变 {
        public void 日期被改变(int var1, int var2, int var3);
    }
}
