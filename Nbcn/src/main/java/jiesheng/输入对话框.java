...
public class 输入对话框
    ...
    public 输入对话框(Context context) {
        ...
        this.builder.setView((View) this.et);
    ...
    public void 内容(String string) {
        this.et.setText((CharSequence) string);
    }
    ...
    public void 提示文本(String string) {
        this.et.setHint((CharSequence) string);
    }
    ...
    public static interface 输入内容被改变 {
        public void 输入内容被改变(String var1);
    }
}
