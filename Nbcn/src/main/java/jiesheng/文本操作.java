...
public class 文本操作 {
    public static int 寻找文本(String string, String string2, int n) {
        if (n < 0 || n > string.length() || "".equals((Object) string) || "".equals((Object) string2)) {
            return -1;
        }
    ...
    public static String 取文本右边(String string, int n) {
        ...
        return n <= string.length() ? string.substring(string.length() - n, string.length()) : string;
    }

    public static String 取文本中间(String string, int n, int n2) {
        if ("".equals((Object) string) || n < 0 || n2 <= 0 || n > string.length()) {
            return "";
        }
        int n3 = n + n2;
        if (n3 > string.length()) {
    ...
    public static String 子文本替换(String string, String string2, String string3) {
        if ("".equals((Object) string2) || "".equals((Object) string)) {
            return "";
        }
    ...
    public static String 子文本替换(String string, int n, int n2, String string2) {
        if ("".equals((Object) string) || n < 0 || n > string.length() || n2 < n || n2 > string.length()) {
            return "";
        }
    ...
    public static String[] 分割文本(String string, String string2) {
        ...
        if (文本操作.取文本右边(string, 文本操作.length(string2)).equals((Object) string2)) {
    ...
    public static String[] 取指定文本(String string, String string2, String string3) {
        if ("".equals((Object) string) || "".equals((Object) string2) || "".equals((Object) string3)) {
            return new String[0];
        }
