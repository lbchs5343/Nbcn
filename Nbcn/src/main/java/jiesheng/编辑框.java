...
public class 编辑框
    ...
    public void 提示文本(String string) {
        this.getView().setHint((CharSequence) string);
    }
    ...
    public void 提示文本颜色(String string) {
        this.提示文本颜色(Color.parseColor((String) string));
    }
    ...
    public void 插入文本(int n, String string) {
        this.getView().getText().insert(n, (CharSequence) string);
    }

    public void 追加文本(String string) {
        this.getView().getText().append((CharSequence) string);
    }

    public void 显示输入法() {
        ((InputMethodManager) this.窗口环境.getSystemService("input_method")).showSoftInput((View) this.getView(), 0);
    }

    public void 隐藏输入法() {
        ((InputMethodManager) this.窗口环境.getSystemService("input_method")).hideSoftInputFromWindow(this.getView().getApplicationWindowToken(), 0);
    }
