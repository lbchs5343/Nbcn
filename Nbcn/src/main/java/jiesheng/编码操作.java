...
public class 编码操作 {
    ...
    public static String URL解码(String string) {
        return URLDecoder.decode((String) string);
    }

    public static String URL编码(String string, String string2) {
        try {
            return URLEncoder.encode((String) string, (String) string2);
    ...
    public static String URL解码(String string, String string2) {
        try {
            return URLDecoder.decode((String) string, (String) string2);
        } catch (UnsupportedEncodingException unsupportedEncodingException) {
            return "";
        }
    }
    ...
    public static String UCS2编码(String string) {
        ...
        for (int i = 0; i < string.length(); ++i) {
            String string3 = Integer.toHexString((int) (string.charAt(i) & 0xFFFF));
            if (string3.length() == 2) {
                string3 = "00" + string3;
            }
