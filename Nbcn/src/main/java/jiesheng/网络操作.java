...
public class 网络操作
    ...
    public static interface 上传失败 {
        public void 上传失败(String var1);
    }

    public static interface 下载失败 {
        public void 下载失败(String var1);
    }

    public static interface 发送数据失败 {
        public void 发送数据失败(String var1);
    }

    public static interface 取网页源码失败 {
        public void 取网页源码失败(String var1);
    }

    public static interface 上传结束 {
        public void 上传结束(String var1, String var2);
    }

    public static interface 正在上传 {
        public void 正在上传(int var1);
    }

    public static interface 下载结束 {
        public void 下载结束(String var1);
    }

    public static interface 正在下载 {
        public void 正在下载(int var1);
    }

    public static interface 发送数据结束 {
        public void 发送数据结束(String var1, String var2);
    }

    public static interface 取网页源码结束 {
        public void 取网页源码结束(String var1, String var2);
    }
}
