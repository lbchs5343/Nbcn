...
public class 位置传感器
    ...
    public boolean 是否有效() {
        ...
        List list = this.locationManager.getAllProviders();
        if (list != null) {
            return list.contains((Object) "gps");
        }
        return false;
    }
    ...
    public static interface 设备关闭 {
        public void 设备关闭();
    }

    public static interface 设备开启 {
        public void 设备开启();
    }

    public static interface 状态改变 {
        public void 状态改变(int var1);
    }

    public static interface 位置改变 {
        public void 位置改变(double var1, double var3, double var5, double var7, double var9);
    }
}
