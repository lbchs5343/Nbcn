...
public class 动画操作 {
    ...
    public static void 播放属性动画(可视化组件 可视化组件2, String string, float... fArray) {
        ObjectAnimator.ofFloat((Object) 可视化组件2.getView(), (String) (namesMap.containsKey((Object) string.toUpperCase()) ? (String) namesMap.get((Object) string.toUpperCase()) : string), (float[]) fArray).start();
    }

    public static void 播放属性动画(可视化组件 可视化组件2, long l, String string, float... fArray) {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat((Object) 可视化组件2.getView(), (String) (namesMap.containsKey((Object) string.toUpperCase()) ? (String) namesMap.get((Object) string.toUpperCase()) : string), (float[]) fArray);
    ...
    public static Object 加载属性动画(可视化组件 可视化组件2, String string, float... fArray) {
        return ObjectAnimator.ofFloat((Object) 可视化组件2.getView(), (String) (namesMap.containsKey((Object) string.toUpperCase()) ? (String) namesMap.get((Object) string.toUpperCase()) : string), (float[]) fArray);
    }
    ...
    public static void 播放渐变伸缩动画(可视化组件 可视化组件2, float f, float f2, float f3, float f4) {
        ...
        可视化组件2.getView().startAnimation((Animation) scaleAnimation);
    }

    public static void 播放渐变坐标动画(可视化组件 可视化组件2, float f, float f2, float f3, float f4) {
        TranslateAnimation translateAnimation = new TranslateAnimation(f, f2, f3, f4);
        可视化组件2.getView().startAnimation((Animation) translateAnimation);
    }
    ...
    public static Object 置属性动画周期(Object object, int n) {
        return ((Animator) object).setDuration((long) n);
    }
    ...
    public static void 置渐变动画周期(Object object, int n) {
        ((Animation) object).setDuration((long) n);
    }
    ...
    public static void 置属性动画延时(Object object, int n) {
        ((Animator) object).setStartDelay((long) n);
    }
