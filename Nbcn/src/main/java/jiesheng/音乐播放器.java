...
public class 音乐播放器
    ...
    public 音乐播放器(Context context) {
        ...
        this.handleProgress = new Handler() {

            public void handleMessage(Message message) {
                if (音乐播放器.this.$event_internal_音乐正在播放 != null) {
                    音乐播放器.this.$event_internal_音乐正在播放.音乐正在播放();
                }
            }
        };
    }
    ...
    public static interface 音乐播放完毕 {
        public void 音乐播放完毕();
    }

    public static interface 音乐正在播放 {
        public void 音乐正在播放();
    }

    public static interface 音乐缓冲完毕 {
        public void 音乐缓冲完毕();
    }

    public static interface 音乐正在缓冲 {
        public void 音乐正在缓冲(int var1);
    }
}
