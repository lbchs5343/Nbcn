...
public class 简单分页布局
    ...
    public static class PageLayout
        ...
        private void init(Context context) {
            ...
            int mTouchSlop = viewConfiguration.getScaledTouchSlop();
        ...
        public void addView(View view, ViewGroup.LayoutParams layoutParams) {
            ...
            this.wrapper.addView(frameLayout);
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (n == 1) {
                ...
                if (n4 > this.mMinimumVelocity && n4 > n5) {
                    if (n3 > 0) {
                        this.showPage(Math.max(0, this.mIdx - 1));
                    } else {
                        this.showPage(Math.min(this.wrapper.getChildCount() - 1, this.mIdx + 1));
                    }
                    return true;
                }
        ...
        public void showPage(int n) {
            ...
            if (this.mOnPageChangeListener != null && this.mIdx != n) {
                this.mOnPageChangeListener.onPageChange(this, n);
            }
            this.mIdx = n;
        }
        ...
        public void showPage(View view) {
            ...
            for (int i = 0; i < n; ++i) {
                if (!this.wrapper.getChildAt(i).equals(view)) continue;
                this.showPage(i);
            }
        }
