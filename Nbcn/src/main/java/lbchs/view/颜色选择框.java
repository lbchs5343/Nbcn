...
public class 颜色选择框
    ...
    public interface 按钮被单击 {
        void 按钮被单击();
    }

    public interface 颜色被改变 {
        void 颜色被改变(int var1);
    }
    ...
    static class ColorPickerDialog
        ...
        protected void onCreate(Bundle bundle) {
            ...
            if (this.是否为竖屏(this.mContext)) {
                ...
                linearLayout.addView(portraitColorPickerView);
                ...
                linearLayout.addView(landscapeColorPickerView);
                linearLayout.addView(this.button);
            }
        ...
        private class PortraitColorPickerView
            ...
            public PortraitColorPickerView(Context context, OnColorChangedListener onColorChangedListener) {
                ...
                Display display = Objects.requireNonNull(ColorPickerDialog.this.getWindow()).getWindowManager().getDefaultDisplay();
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawLine(this.mRectLeft - f, this.mRectTop - f * 2.0f, this.mRectLeft - f, f * 2.0f + this.mRectBottom, this.mLinePaint);
                canvas.drawLine(this.mRectLeft - f * 2.0f, this.mRectTop - f, f * 2.0f + this.mRectRight, this.mRectTop - f, this.mLinePaint);
                canvas.drawLine(this.mRectRight + f, this.mRectTop - f * 2.0f, this.mRectRight + f, f * 2.0f + this.mRectBottom, this.mLinePaint);
                canvas.drawLine(this.mRectLeft - f * 2.0f, this.mRectBottom + f, f * 2.0f + this.mRectRight, this.mRectBottom + f, this.mLinePaint);
                super.onDraw(canvas);
            }
            ...
            public int interpRectColor(int[] nArray, float f, float f2) {
                ...
                return Color.argb(this.ave(Color.alpha(n2), Color.alpha(n), f3), this.ave(Color.red(n2), Color.red(n), f3), this.ave(Color.green(n2), Color.green(n), f3), this.ave(Color.blue(n2), Color.blue(n), f3));
            }
        }
        ...
        protected abstract class ColorPickerView
            ...
            public int interpCircleColor(int[] nArray, float f) {
                ...
                int n2 = nArray[n];
                int n3 = nArray[n + 1];
                return Color.argb(this.ave(Color.alpha(n2), Color.alpha(n3), f2 -= (float) n), this.ave(Color.red(n2), Color.red(n3), f2), this.ave(Color.green(n2), Color.green(n3), f2), this.ave(Color.blue(n2), Color.blue(n3), f2));
            }
            ...
            public void onActionMove(float f, float f2, boolean bl, boolean bl2, boolean bl3) {
                if (this.mDownInCircle && bl) {
                    float f3 = (float) ((double) ((float) Math.atan2(f2, f)) / (Math.PI * 2));
                    if (f3 < 0.0f) {
                        f3 += 1.0f;
                    }
