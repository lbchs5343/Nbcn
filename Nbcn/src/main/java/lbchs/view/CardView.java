...
public class CardView
    ...
    private static final CardViewImpl IMPL = Build.VERSION.SDK_INT >= 21 ? new CardViewApi21() : new CardViewJellybeanMr1();
    ...
    protected void onMeasure(int n, int n2) {
        if (!(IMPL instanceof CardViewApi21)) {
            ...
            switch (n4) {
                case -2147483648:
                case 0x40000000: {
                    n3 = (int) Math.ceil(IMPL.getMinWidth(this));
                    n = View.MeasureSpec.makeMeasureSpec(Math.max(n3, MeasureSpec.getSize(n)), n4);
                }
            }
            ...
            switch (n3) {
                case -2147483648:
                case 0x40000000: {
                    int n5 = (int) Math.ceil(IMPL.getMinHeight(this));
                    n2 = View.MeasureSpec.makeMeasureSpec(Math.max(n5, MeasureSpec.getSize(n2)), n3);
                }
            }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        int n2;
        try (TypedArray typedArray = context.getTheme().obtainStyledAttributes(new int[]{0x1010031})) {
            n2 = typedArray.getColor(0, -328966);
            typedArray.recycle();
        }
        float f = this.dp();
        float f2 = this.dp();
    ...
    private float dp() {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (float) 2.0, this.dm);
    }
