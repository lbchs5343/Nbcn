...
public class TTS
        extends 组件 {
    private static final HashMap<String, Locale> map = new HashMap<>();
    ...
    public TTS(Context context) {
        super(context);
        this.mSpeech = new TextToSpeech(context, new TTSListener());
    ...
    public void 语言(String string) {
        this.mSpeech.setLanguage(map.containsKey(string) ? map.get(string) : Locale.CHINESE);
    }
    ...
    public interface 初始化完毕 {
        void 初始化完毕(boolean var1);
    }
