...
public class 时间选择框
    ...
    private final TimePickerDialog dialog;
    ...
    public static String timePickerBox(Context context, int n, int n2) {
        ...
        timePickerDialog.setButton("确定", new DialogInterface.OnClickListener() {

            public void onClick(DialogInterface dialogInterface, int n) {
                handler.sendMessage(handler.obtainMessage());
            }
        });
        timePickerDialog.setButton2("取消", new DialogInterface.OnClickListener() {
    ...
    public interface 时间被确定 {
        void 时间被确定(int var1, int var2);
    }

    public interface 时间被改变 {
        void 时间被改变(int var1, int var2);
    }
}
